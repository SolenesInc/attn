...
const APP_ENV_ALWAYS_ON_TOP = `ATTN_HARNESS_PARK_VISIBLE_PX=20\n${ALWAYS_ON_TOP_VAR}=1\nHOME=/Users/x`;
const APP_ENV_OPTED_OUT = `ATTN_HARNESS_PARK_VISIBLE_PX=0\n${ALWAYS_ON_TOP_VAR}=0\nHOME=/Users/x`;
...
describe('keyInputVerdict', () => {
  ...
  it('does not read a bare 1 out of a neighbouring variable', () => {
    const environment = `ATTN_HARNESS_PARK_VISIBLE_PX=1\n${ALWAYS_ON_TOP_VAR}=0`;
