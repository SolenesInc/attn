...
export const SHORTCUT_META: Record<ShortcutId, ShortcutMeta> = {
  ...
  'session.prev': { label: 'Previous workspace', category: 'sessions' },
  'session.next': { label: 'Next workspace', category: 'sessions' },
  ...
  'setup.switch': { label: 'Switch setup', category: 'sessions' },
  ...
  'workspace.select1': { label: 'Switch to desktop 1', category: 'sessions' },
  'workspace.select2': { label: 'Switch to desktop 2', category: 'sessions' },
  'workspace.select3': { label: 'Switch to desktop 3', category: 'sessions' },
  'workspace.select4': { label: 'Switch to desktop 4', category: 'sessions' },
  'workspace.select5': { label: 'Switch to desktop 5', category: 'sessions' },
