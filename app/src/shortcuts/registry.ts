...
export const MAC_SHORTCUTS = {
  ...
  'session.historyBack': { key: '[', code: 'BracketLeft', meta: true },
  ...
  'desktop.select2': { key: '2', code: 'Digit2', meta: true },
  'desktop.select3': { key: '3', code: 'Digit3', meta: true },
  'desktop.select4': { key: '4', code: 'Digit4', meta: true },
  'desktop.select5': { key: '5', code: 'Digit5', meta: true },
  'desktop.select6': { key: '6', code: 'Digit6', meta: true },
  'desktop.select7': { key: '7', code: 'Digit7', meta: true },
  'desktop.select8': { key: '8', code: 'Digit8', meta: true },
  'desktop.select9': { key: '9', code: 'Digit9', meta: true },
...
export const LINUX_SHORTCUTS = {
  ...
  'session.historyBack': { key: '{', code: 'BracketLeft', meta: true, shift: true },
  ...
  'desktop.select1': { key: '1', code: 'Digit1', meta: true, shift: true },
  'desktop.select2': { key: '2', code: 'Digit2', meta: true, shift: true },
  'desktop.select3': { key: '3', code: 'Digit3', meta: true, shift: true },
  'desktop.select4': { key: '4', code: 'Digit4', meta: true, shift: true },
  'desktop.select5': { key: '5', code: 'Digit5', meta: true, shift: true },
  'desktop.select6': { key: '6', code: 'Digit6', meta: true, shift: true },
  'desktop.select7': { key: '7', code: 'Digit7', meta: true, shift: true },
  'desktop.select8': { key: '8', code: 'Digit8', meta: true, shift: true },
  'desktop.select9': { key: '9', code: 'Digit9', meta: true, shift: true },
