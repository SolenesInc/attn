...
//   const delegationPreferencesOrigin = Convert.toDelegationPreferencesOrigin(json);
...
export enum DelegationPreferencesOrigin {
    CLI = "cli",
    Settings = "settings",
}
...
export class Convert {
    ...
    public static toDelegationPreferencesOrigin(json: string): DelegationPreferencesOrigin {
        return cast(JSON.parse(json), r("DelegationPreferencesOrigin"));
    }

    public static delegationPreferencesOriginToJson(value: DelegationPreferencesOrigin): string {
        return JSON.stringify(uncast(value, r("DelegationPreferencesOrigin")), null, 2);
    }
