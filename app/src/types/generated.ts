...
//   const desktopTileContentGetMessage = Convert.toDesktopTileContentGetMessage(json);
...
export interface DesktopTileContentGetMessage {
    cmd:        DesktopTileContentGetMessageCmd;
    desktop_id: string;
    tile_id:    string;
    [property: string]: any;
}

export enum DesktopTileContentGetMessageCmd {
    DesktopTileContentGet = "desktop_tile_content_get",
}
...
export class Convert {
    ...
    public static toDesktopTileContentGetMessage(json: string): DesktopTileContentGetMessage {
        return cast(JSON.parse(json), r("DesktopTileContentGetMessage"));
    }

    public static desktopTileContentGetMessageToJson(value: DesktopTileContentGetMessage): string {
        return JSON.stringify(uncast(value, r("DesktopTileContentGetMessage")), null, 2);
    }
...
const typeMap: any = {
    ...
    "DesktopTileContentGetMessage": o([
        { json: "cmd", js: "cmd", typ: r("DesktopTileContentGetMessageCmd") },
        { json: "desktop_id", js: "desktop_id", typ: "" },
        { json: "tile_id", js: "tile_id", typ: "" },
    ], "any"),
    ...
    "DesktopTileContentGetMessageCmd": [
        "desktop_tile_content_get",
    ],
