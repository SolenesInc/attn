...
//   const sessionReopenDelivery = Convert.toSessionReopenDelivery(json);
...
export interface SessionListMessage {
    ...
    limit?:           number;
    reopen?:          boolean;
    reopen_delivery?: SessionReopenDelivery;
    repository?:      string;
    request_id?:      string;
    since?:           string;
    until?:           string;
...
export enum SessionReopenDelivery {
    Inline = "inline",
    Stream = "stream",
}
...
export class Convert {
    ...
    public static toSessionReopenDelivery(json: string): SessionReopenDelivery {
        return cast(JSON.parse(json), r("SessionReopenDelivery"));
    }

    public static sessionReopenDeliveryToJson(value: SessionReopenDelivery): string {
        return JSON.stringify(uncast(value, r("SessionReopenDelivery")), null, 2);
    }
...
const typeMap: any = {
    ...
    "SessionListMessage": o([
        ...
        { json: "reopen_delivery", js: "reopen_delivery", typ: u(undefined, r("SessionReopenDelivery")) },
        { json: "repository", js: "repository", typ: u(undefined, "") },
        { json: "request_id", js: "request_id", typ: u(undefined, "") },
