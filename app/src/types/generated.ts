...
//   const crewHandoffGetResult = Convert.toCrewHandoffGetResult(json);
//   const crewHandoffGetResultMessage = Convert.toCrewHandoffGetResultMessage(json);
//   const crewHandoffMessage = Convert.toCrewHandoffMessage(json);
//   const crewHandoffResult = Convert.toCrewHandoffResult(json);
//   const crewHandoffSummary = Convert.toCrewHandoffSummary(json);
...
//   const pullRequestUnwatchMessage = Convert.toPullRequestUnwatchMessage(json);
//   const pullRequestUnwatchResultMessage = Convert.toPullRequestUnwatchResultMessage(json);
//   const pullRequestWatchMessage = Convert.toPullRequestWatchMessage(json);
//   const pullRequestWatchMode = Convert.toPullRequestWatchMode(json);
//   const pullRequestWatchResultMessage = Convert.toPullRequestWatchResultMessage(json);
...
//   const seedSearchHit = Convert.toSeedSearchHit(json);
//   const seedSearchMessage = Convert.toSeedSearchMessage(json);
//   const seedSearchResult = Convert.toSeedSearchResult(json);
...
//   const sessionReopenEntry = Convert.toSessionReopenEntry(json);
//   const sessionReopenMessage = Convert.toSessionReopenMessage(json);
//   const sessionReopenRefreshedMessage = Convert.toSessionReopenRefreshedMessage(json);
//   const sessionReopenResolvedMessage = Convert.toSessionReopenResolvedMessage(json);
...
//   const sessionReopenUnsubscribeMessage = Convert.toSessionReopenUnsubscribeMessage(json);
...
//   const supportInputTrace = Convert.toSupportInputTrace(json);
//   const supportRuntimeEvidence = Convert.toSupportRuntimeEvidence(json);
//   const supportSnapshotMessage = Convert.toSupportSnapshotMessage(json);
//   const supportSnapshotResultMessage = Convert.toSupportSnapshotResultMessage(json);
...
export enum PullRequestWatchMode {
    Codex = "codex",
...
export enum CrewHandoffGetMessageCmd {
    CrewHandoffGet = "crew_handoff_get",
}

export interface CrewHandoffGetResult {
    handoff: Handoff;
    member:  string;
    [property: string]: any;
}
...
export interface CrewHandoffGetResultMessage {
    error?:     string;
    event:      CrewHandoffGetResultMessageEvent;
    handoff?:   Handoff;
    member?:    string;
    request_id: string;
    success:    boolean;
...
export enum CrewHandoffGetResultMessageEvent {
    CrewHandoffGetResult = "crew_handoff_get_result",
}
...
export interface CrewHandoffSummary {
    filename:    string;
    occurred_at: Date;
    [property: string]: any;
}
...
export interface PullRequestUnwatchMessage {
    cmd:         PullRequestUnwatchMessageCmd;
    id:          string;
    request_id?: string;
    url:         string;
    [property: string]: any;
...
export enum PullRequestUnwatchMessageCmd {
    PullRequestUnwatch = "pull_request_unwatch",
}

export interface PullRequestUnwatchResultMessage {
    error?:     string;
    event:      PullRequestUnwatchResultMessageEvent;
    request_id: string;
    success:    boolean;
    [property: string]: any;
}

export enum PullRequestUnwatchResultMessageEvent {
    PullRequestUnwatchResult = "pull_request_unwatch_result",
}

export interface PullRequestWatchMessage {
    cmd:         PullRequestWatchMessageCmd;
    id:          string;
...
export enum PullRequestWatchMessageCmd {
    PullRequestWatch = "pull_request_watch",
}

export interface PullRequestWatchResultMessage {
    error?:     string;
    event:      PullRequestWatchResultMessageEvent;
    request_id: string;
    success:    boolean;
    [property: string]: any;
}

export enum PullRequestWatchResultMessageEvent {
    PullRequestWatchResult = "pull_request_watch_result",
}
...
export interface SeedSearchResultObject {
    hits:     HitElement[];
    limit:    number;
    matched:  number;
    searched: number;
...
export interface ReopenElement {
    reopen:     Reopen;
    session_id: string;
    [property: string]: any;
}
...
export enum SeedSearchMessageCmd {
    SeedSearch = "seed_search",
}
...
export interface SessionCloseResultMessage {
    accepted:   boolean;
    error?:     string;
    event:      SessionCloseResultMessageEvent;
    session_id: string;
    [property: string]: any;
}

export enum SessionCloseResultMessageEvent {
    SessionCloseResult = "session_close_result",
}
...
export interface SessionReopenEntry {
    reopen:     Reopen;
    session_id: string;
    [property: string]: any;
}
...
export interface SessionReopenRefreshedMessage {
    event:      SessionReopenRefreshedMessageEvent;
    reopen:     Reopen;
    session_id: string;
    [property: string]: any;
}

export enum SessionReopenRefreshedMessageEvent {
    SessionReopenRefreshed = "session_reopen_refreshed",
}

export interface SessionReopenResolvedMessage {
    closed_at:  string;
    error?:     string;
    event:      SessionReopenResolvedMessageEvent;
    reopen?:    Reopen;
    session_id: string;
    success:    boolean;
    [property: string]: any;
...
export enum SessionReopenResolvedMessageEvent {
    SessionReopenResolved = "session_reopen_resolved",
}
...
export interface SessionReopenResultMessage {
    error?:     string;
    event:      SessionReopenResultMessageEvent;
    request_id: string;
    result?:    SessionReopenResultObject;
    success:    boolean;
    [property: string]: any;
}
...
export interface SessionReopenUnsubscribeMessage {
    cmd: SessionReopenUnsubscribeMessageCmd;
    [property: string]: any;
}

export enum SessionReopenUnsubscribeMessageCmd {
    SessionReopenUnsubscribe = "session_reopen_unsubscribe",
}
...
export interface SupportInputTrace {
    byte_count:          number;
    error_class?:        string;
...
export interface SupportRuntimeEvidence {
    attached:             boolean;
    backend:              string;
    cols?:                number;
...
export interface SupportSnapshotMessage {
...
export enum SupportSnapshotMessageCmd {
    SupportSnapshot = "support_snapshot",
}

export interface SupportSnapshotResultMessage {
    backend:                   string;
    captured_at_unix_ms:       number;
    daemon_instance_id:        string;
    daemon_started_at_unix_ms: number;
    endpoint_id?:              string;
    event:                     SupportSnapshotResultMessageEvent;
    input_traces:              InputTraceElement[];
    protocol_version:          string;
    request_id:                string;
    runtimes:                  RuntimeElement[];
...
export enum SupportSnapshotResultMessageEvent {
    SupportSnapshotResult = "support_snapshot_result",
}

export interface InputTraceElement {
    byte_count:          number;
    error_class?:        string;
    received_at_unix_ms: number;
    runtime_id:          string;
...
export class Convert {
    ...
    public static toCrewHandoffGetMessage(json: string): CrewHandoffGetMessage {
        return cast(JSON.parse(json), r("CrewHandoffGetMessage"));
    }

    public static crewHandoffGetMessageToJson(value: CrewHandoffGetMessage): string {
        return JSON.stringify(uncast(value, r("CrewHandoffGetMessage")), null, 2);
    }

    public static toCrewHandoffGetResult(json: string): CrewHandoffGetResult {
        return cast(JSON.parse(json), r("CrewHandoffGetResult"));
    }

    public static crewHandoffGetResultToJson(value: CrewHandoffGetResult): string {
        return JSON.stringify(uncast(value, r("CrewHandoffGetResult")), null, 2);
    }

    public static toCrewHandoffGetResultMessage(json: string): CrewHandoffGetResultMessage {
        return cast(JSON.parse(json), r("CrewHandoffGetResultMessage"));
    }

    public static crewHandoffGetResultMessageToJson(value: CrewHandoffGetResultMessage): string {
        return JSON.stringify(uncast(value, r("CrewHandoffGetResultMessage")), null, 2);
    }
    ...
    public static toCrewHandoffSummary(json: string): CrewHandoffSummary {
        return cast(JSON.parse(json), r("CrewHandoffSummary"));
    }

    public static crewHandoffSummaryToJson(value: CrewHandoffSummary): string {
        return JSON.stringify(uncast(value, r("CrewHandoffSummary")), null, 2);
    }
    ...
    public static toPullRequestUnwatchMessage(json: string): PullRequestUnwatchMessage {
        return cast(JSON.parse(json), r("PullRequestUnwatchMessage"));
    }

    public static pullRequestUnwatchMessageToJson(value: PullRequestUnwatchMessage): string {
        return JSON.stringify(uncast(value, r("PullRequestUnwatchMessage")), null, 2);
    }

    public static toPullRequestUnwatchResultMessage(json: string): PullRequestUnwatchResultMessage {
        return cast(JSON.parse(json), r("PullRequestUnwatchResultMessage"));
    }

    public static pullRequestUnwatchResultMessageToJson(value: PullRequestUnwatchResultMessage): string {
        return JSON.stringify(uncast(value, r("PullRequestUnwatchResultMessage")), null, 2);
    }

    public static toPullRequestWatchMessage(json: string): PullRequestWatchMessage {
        return cast(JSON.parse(json), r("PullRequestWatchMessage"));
    }

    public static pullRequestWatchMessageToJson(value: PullRequestWatchMessage): string {
        return JSON.stringify(uncast(value, r("PullRequestWatchMessage")), null, 2);
    }

    public static toPullRequestWatchMode(json: string): PullRequestWatchMode {
        return cast(JSON.parse(json), r("PullRequestWatchMode"));
    }

    public static pullRequestWatchModeToJson(value: PullRequestWatchMode): string {
        return JSON.stringify(uncast(value, r("PullRequestWatchMode")), null, 2);
    }

    public static toPullRequestWatchResultMessage(json: string): PullRequestWatchResultMessage {
        return cast(JSON.parse(json), r("PullRequestWatchResultMessage"));
    }

    public static pullRequestWatchResultMessageToJson(value: PullRequestWatchResultMessage): string {
        return JSON.stringify(uncast(value, r("PullRequestWatchResultMessage")), null, 2);
    }
    ...
    public static toSeedSearchHit(json: string): SeedSearchHit {
        return cast(JSON.parse(json), r("SeedSearchHit"));
    }

    public static seedSearchHitToJson(value: SeedSearchHit): string {
        return JSON.stringify(uncast(value, r("SeedSearchHit")), null, 2);
    }

    public static toSeedSearchMessage(json: string): SeedSearchMessage {
        return cast(JSON.parse(json), r("SeedSearchMessage"));
    }

    public static seedSearchMessageToJson(value: SeedSearchMessage): string {
        return JSON.stringify(uncast(value, r("SeedSearchMessage")), null, 2);
    }

    public static toSeedSearchResult(json: string): SeedSearchResult {
        return cast(JSON.parse(json), r("SeedSearchResult"));
    }

    public static seedSearchResultToJson(value: SeedSearchResult): string {
        return JSON.stringify(uncast(value, r("SeedSearchResult")), null, 2);
    }
    ...
    public static toSessionCloseResultMessage(json: string): SessionCloseResultMessage {
        return cast(JSON.parse(json), r("SessionCloseResultMessage"));
    }

    public static sessionCloseResultMessageToJson(value: SessionCloseResultMessage): string {
        return JSON.stringify(uncast(value, r("SessionCloseResultMessage")), null, 2);
    }
    ...
    public static toSessionReopenEntry(json: string): SessionReopenEntry {
        return cast(JSON.parse(json), r("SessionReopenEntry"));
    }

    public static sessionReopenEntryToJson(value: SessionReopenEntry): string {
        return JSON.stringify(uncast(value, r("SessionReopenEntry")), null, 2);
    }
    ...
    public static toSessionReopenRefreshedMessage(json: string): SessionReopenRefreshedMessage {
        return cast(JSON.parse(json), r("SessionReopenRefreshedMessage"));
    }

    public static sessionReopenRefreshedMessageToJson(value: SessionReopenRefreshedMessage): string {
        return JSON.stringify(uncast(value, r("SessionReopenRefreshedMessage")), null, 2);
    }

    public static toSessionReopenResolvedMessage(json: string): SessionReopenResolvedMessage {
        return cast(JSON.parse(json), r("SessionReopenResolvedMessage"));
    }

    public static sessionReopenResolvedMessageToJson(value: SessionReopenResolvedMessage): string {
        return JSON.stringify(uncast(value, r("SessionReopenResolvedMessage")), null, 2);
    }
    ...
    public static toSessionReopenResultMessage(json: string): SessionReopenResultMessage {
        return cast(JSON.parse(json), r("SessionReopenResultMessage"));
    }
    ...
    public static toSessionReopenUnsubscribeMessage(json: string): SessionReopenUnsubscribeMessage {
        return cast(JSON.parse(json), r("SessionReopenUnsubscribeMessage"));
    }

    public static sessionReopenUnsubscribeMessageToJson(value: SessionReopenUnsubscribeMessage): string {
        return JSON.stringify(uncast(value, r("SessionReopenUnsubscribeMessage")), null, 2);
    }
    ...
    public static toSupportInputTrace(json: string): SupportInputTrace {
        return cast(JSON.parse(json), r("SupportInputTrace"));
    }

    public static supportInputTraceToJson(value: SupportInputTrace): string {
        return JSON.stringify(uncast(value, r("SupportInputTrace")), null, 2);
    }

    public static toSupportRuntimeEvidence(json: string): SupportRuntimeEvidence {
        return cast(JSON.parse(json), r("SupportRuntimeEvidence"));
    }

    public static supportRuntimeEvidenceToJson(value: SupportRuntimeEvidence): string {
        return JSON.stringify(uncast(value, r("SupportRuntimeEvidence")), null, 2);
    }

    public static toSupportSnapshotMessage(json: string): SupportSnapshotMessage {
        return cast(JSON.parse(json), r("SupportSnapshotMessage"));
    }

    public static supportSnapshotMessageToJson(value: SupportSnapshotMessage): string {
        return JSON.stringify(uncast(value, r("SupportSnapshotMessage")), null, 2);
    }

    public static toSupportSnapshotResultMessage(json: string): SupportSnapshotResultMessage {
        return cast(JSON.parse(json), r("SupportSnapshotResultMessage"));
    }

    public static supportSnapshotResultMessageToJson(value: SupportSnapshotResultMessage): string {
        return JSON.stringify(uncast(value, r("SupportSnapshotResultMessage")), null, 2);
    }
...
const typeMap: any = {
    ...
    "PullRequestElement": o([
        ...
        { json: "number", js: "number", typ: 0 },
        { json: "readiness_reason", js: "readiness_reason", typ: u(undefined, "") },
        { json: "readiness_state", js: "readiness_state", typ: u(undefined, "") },
        { json: "repository", js: "repository", typ: "" },
        { json: "review_status", js: "review_status", typ: u(undefined, "") },
        { json: "settling_until", js: "settling_until", typ: u(undefined, "") },
        { json: "state", js: "state", typ: "" },
        { json: "status_fetched_at", js: "status_fetched_at", typ: u(undefined, "") },
        { json: "title", js: "title", typ: u(undefined, "") },
        { json: "url", js: "url", typ: "" },
        { json: "watch_error", js: "watch_error", typ: u(undefined, "") },
    ...
    "CrewHandoffGetResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("CrewHandoffGetResultMessageEvent") },
        { json: "handoff", js: "handoff", typ: u(undefined, r("Handoff")) },
        { json: "member", js: "member", typ: u(undefined, "") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "success", js: "success", typ: true },
    ], "any"),
    ...
    "PtyInputMessage": o([
        ...
        { json: "trace_id", js: "trace_id", typ: u(undefined, "") },
    ], "any"),
    ...
    "PullRequestUnwatchMessage": o([
        { json: "cmd", js: "cmd", typ: r("PullRequestUnwatchMessageCmd") },
        { json: "id", js: "id", typ: "" },
        { json: "request_id", js: "request_id", typ: u(undefined, "") },
        { json: "url", js: "url", typ: "" },
    ], "any"),
    "PullRequestUnwatchResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("PullRequestUnwatchResultMessageEvent") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "success", js: "success", typ: true },
    ], "any"),
    "PullRequestWatchMessage": o([
        { json: "cmd", js: "cmd", typ: r("PullRequestWatchMessageCmd") },
        { json: "id", js: "id", typ: "" },
        { json: "mode", js: "mode", typ: r("PullRequestWatchMode") },
        { json: "request_id", js: "request_id", typ: u(undefined, "") },
        { json: "reviewer", js: "reviewer", typ: u(undefined, "") },
        { json: "url", js: "url", typ: "" },
    ], "any"),
    "PullRequestWatchResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("PullRequestWatchResultMessageEvent") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "success", js: "success", typ: true },
    ], "any"),
    ...
    "SeedSearchResultObject": o([
        { json: "hits", js: "hits", typ: a(r("HitElement")) },
        { json: "limit", js: "limit", typ: 0 },
        { json: "matched", js: "matched", typ: 0 },
        { json: "searched", js: "searched", typ: 0 },
    ], "any"),
    "HitElement": o([
        { json: "seed", js: "seed", typ: r("SeedElement") },
    ...
    "SessionListResultObject": o([
        ...
        { json: "reopen", js: "reopen", typ: u(undefined, a(r("ReopenElement"))) },
    ], "any"),
    "Entry": o([
        { json: "agent", js: "agent", typ: "" },
        { json: "branch", js: "branch", typ: u(undefined, "") },
    ...
    "WorktreeListResultObject": o([
        { json: "omitted", js: "omitted", typ: 0 },
        { json: "repositories", js: "repositories", typ: a(r("RepositoryObject")) },
        { json: "worktrees", js: "worktrees", typ: a(r("WorktreeElement")) },
    ], "any"),
    "RepositoryObject": o([
    ...
    "SessionCloseResultMessage": o([
        { json: "accepted", js: "accepted", typ: true },
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("SessionCloseResultMessageEvent") },
        { json: "session_id", js: "session_id", typ: "" },
    ], "any"),
    ...
    "SessionReopenRefreshedMessage": o([
        { json: "event", js: "event", typ: r("SessionReopenRefreshedMessageEvent") },
        { json: "reopen", js: "reopen", typ: r("Reopen") },
        { json: "session_id", js: "session_id", typ: "" },
    ], "any"),
    "SessionReopenResolvedMessage": o([
        { json: "closed_at", js: "closed_at", typ: "" },
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("SessionReopenResolvedMessageEvent") },
        { json: "reopen", js: "reopen", typ: u(undefined, r("Reopen")) },
        { json: "session_id", js: "session_id", typ: "" },
        { json: "success", js: "success", typ: true },
    ], "any"),
    ...
    "SessionReopenResultMessage": o([
        { json: "error", js: "error", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("SessionReopenResultMessageEvent") },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "result", js: "result", typ: u(undefined, r("SessionReopenResultObject")) },
        { json: "success", js: "success", typ: true },
    ], "any"),
    "SessionReopenUnsubscribeMessage": o([
        { json: "cmd", js: "cmd", typ: r("SessionReopenUnsubscribeMessageCmd") },
    ], "any"),
    ...
    "SupportInputTrace": o([
        { json: "byte_count", js: "byte_count", typ: 0 },
        { json: "error_class", js: "error_class", typ: u(undefined, "") },
        { json: "received_at_unix_ms", js: "received_at_unix_ms", typ: 0 },
        { json: "runtime_id", js: "runtime_id", typ: "" },
        { json: "sequence", js: "sequence", typ: 0 },
        { json: "source", js: "source", typ: "" },
        { json: "trace_id", js: "trace_id", typ: "" },
        { json: "write_duration_us", js: "write_duration_us", typ: 0 },
        { json: "write_result", js: "write_result", typ: "" },
    ], "any"),
    "SupportRuntimeEvidence": o([
        { json: "attached", js: "attached", typ: true },
        { json: "backend", js: "backend", typ: "" },
        { json: "cols", js: "cols", typ: u(undefined, 0) },
        { json: "info_error_class", js: "info_error_class", typ: u(undefined, "") },
        { json: "last_seq", js: "last_seq", typ: u(undefined, 0) },
        { json: "pid", js: "pid", typ: u(undefined, 0) },
        { json: "rows", js: "rows", typ: u(undefined, 0) },
        { json: "running", js: "running", typ: u(undefined, true) },
        ...
        { json: "terminal_build", js: "terminal_build", typ: u(undefined, "") },
        { json: "terminal_build_known", js: "terminal_build_known", typ: true },
    ], "any"),
    "SupportSnapshotMessage": o([
    ...
    "SupportSnapshotResultMessage": o([
        { json: "backend", js: "backend", typ: "" },
        { json: "captured_at_unix_ms", js: "captured_at_unix_ms", typ: 0 },
        { json: "daemon_instance_id", js: "daemon_instance_id", typ: "" },
        { json: "daemon_started_at_unix_ms", js: "daemon_started_at_unix_ms", typ: 0 },
        { json: "endpoint_id", js: "endpoint_id", typ: u(undefined, "") },
        { json: "event", js: "event", typ: r("SupportSnapshotResultMessageEvent") },
        { json: "input_traces", js: "input_traces", typ: a(r("InputTraceElement")) },
        { json: "protocol_version", js: "protocol_version", typ: "" },
        { json: "request_id", js: "request_id", typ: "" },
        { json: "runtimes", js: "runtimes", typ: a(r("RuntimeElement")) },
        { json: "trace_capacity", js: "trace_capacity", typ: 0 },
        { json: "trace_total", js: "trace_total", typ: 0 },
        { json: "warning_codes", js: "warning_codes", typ: a("") },
    ], "any"),
    "InputTraceElement": o([
        { json: "byte_count", js: "byte_count", typ: 0 },
        { json: "error_class", js: "error_class", typ: u(undefined, "") },
    ...
    "CrewHandoffGetResultMessageEvent": [
    ...
    "PullRequestUnwatchMessageCmd": [
        "pull_request_unwatch",
    ],
    "PullRequestUnwatchResultMessageEvent": [
        "pull_request_unwatch_result",
    ],
    "PullRequestWatchMessageCmd": [
        "pull_request_watch",
    ],
    "PullRequestWatchResultMessageEvent": [
        "pull_request_watch_result",
    ],
    ...
    "SessionCloseResultMessageEvent": [
    ...
    "SessionReopenRefreshedMessageEvent": [
        "session_reopen_refreshed",
    ],
    "SessionReopenResolvedMessageEvent": [
        "session_reopen_resolved",
    ],
    "SessionReopenResultMessageEvent": [
        "session_reopen_result",
    ],
    "SessionReopenUnsubscribeMessageCmd": [
        "session_reopen_unsubscribe",
    ],
    ...
    "SupportSnapshotMessageCmd": [
        "support_snapshot",
    ],
    "SupportSnapshotResultMessageEvent": [
        "support_snapshot_result",
    ],
    "TaskListMessageCmd": [
        "task_list",
    ],
