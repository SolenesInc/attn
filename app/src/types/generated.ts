...
//   const sessionCloseAcceptedMessage = Convert.toSessionCloseAcceptedMessage(json);
...
export interface SessionCloseAcceptedMessage {
    event:      SessionCloseAcceptedMessageEvent;
    session_id: string;
    [property: string]: any;
}

export enum SessionCloseAcceptedMessageEvent {
    SessionCloseAccepted = "session_close_accepted",
}
...
export class Convert {
    ...
    public static toSessionCloseAcceptedMessage(json: string): SessionCloseAcceptedMessage {
        return cast(JSON.parse(json), r("SessionCloseAcceptedMessage"));
    }

    public static sessionCloseAcceptedMessageToJson(value: SessionCloseAcceptedMessage): string {
        return JSON.stringify(uncast(value, r("SessionCloseAcceptedMessage")), null, 2);
    }
...
const typeMap: any = {
    ...
    "SessionCloseAcceptedMessage": o([
        { json: "event", js: "event", typ: r("SessionCloseAcceptedMessageEvent") },
        { json: "session_id", js: "session_id", typ: "" },
    ], "any"),
    ...
    "SessionCloseAcceptedMessageEvent": [
