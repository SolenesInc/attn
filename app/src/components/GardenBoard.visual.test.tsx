...
const world = [
  ...
  seed({
    id: 's-armrdy',
    title: 'armed but still pickable',
    ready: true,
    harvest_when: {
      pull_request: 'github.com:victorarias/attn#43',
      url: 'https://github.com/victorarias/attn/pull/43',
      set_at: '2026-08-27T09:00:00Z',
    },
  }),
