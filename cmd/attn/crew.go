...
commands:
  ...
  set <member> [--cwd <dir>] [--agent <name>] [--model <name>] [--effort <level>]
               [--awareness-dir <dir>]...
        record where the member's sessions launch, which harness, model and
        effort it uses, and which directories its charter is about. Registry state;
        ...
        returns to the crew default, model and effort to harness defaults.
