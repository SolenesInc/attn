...
/** One deadline covers prompt building and every attempt and tool call, not each attempt alone. */
...
/** This string is fed to the agent verbatim as its next turn, not shown to the user. */
...
export class GuardianReviewer implements Reviewer {
  ...
  private async attempt(
    ...
    for (;;) {
      ...
      // Deadline expiry is a timeout, not a retryable transport failure.
