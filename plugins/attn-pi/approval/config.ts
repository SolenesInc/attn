...
// match/notMatch are pi's own validation examples; the daemon stores them without checking them.
export type Rule = {
...
export type Network = {
  ...
  // False by default: the proxy then hard denies a host resolving to loopback or a private address.
