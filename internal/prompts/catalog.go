...
func Definitions() []Recipient {
	...
	recipients = append(recipients, gardenAdvisorRecipient(), piRecipient(), piEnvironmentRecipient(), piSessionRecipient(), activityRecipient(), skillRecipient(), resourceRecipient(), annotationLabelRecipient(), evidenceRecipient())
