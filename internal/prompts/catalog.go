...
func Definitions() []Recipient {
	...
	recipients = append(recipients, gardenAdvisorRecipient(), piEnvironmentRecipient(), piSecurityRecipient(), piGuardianRecipient(), activityRecipient(), skillRecipient(), resourceRecipient(), annotationLabelRecipient(), evidenceRecipient())
