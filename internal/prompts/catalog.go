...
func Definitions() []Recipient {
	...
	recipients = append(recipients, gardenAdvisorRecipient(), piRecipient(), piEnvironmentRecipient(), piSessionRecipient(), piSecurityRecipient(), piGuardianRecipient(), activityRecipient(), skillRecipient(), resourceRecipient(), annotationLabelRecipient(), evidenceRecipient())
