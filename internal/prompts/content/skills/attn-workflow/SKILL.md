---
name: attn-workflow
description: Use when an assigned role refers to this skill or the user requests its processes for investigation, discussion, alignment, debugging, planning, implementation, review, or orchestration.
---
