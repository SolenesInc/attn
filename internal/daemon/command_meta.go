...
var CommandMeta = map[string]CommandMetadata{
	...
	protocol.CmdDelegationPreferencesHistory:          commandMetadata(ScopeHubLocal, false, false),
	protocol.CmdDelegationPreferencesRollback:         commandMetadata(ScopeHubLocal, false, true),
